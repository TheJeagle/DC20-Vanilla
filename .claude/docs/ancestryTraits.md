# DC20 Ancestry Traits

The number in parentheses is the **ancestryValue** — equivalent to `featureCost` in the feature system. Negative values are drawbacks. A combined feature's cost = sum of its component ancestryValues.
...
- **(1) Mental Clarity:** You have ADV on Saves against being Dazed or Stunned.
...
**Draconic Origin:** Choose a Draconic Origin from the list below. All future choices within this Ancestry must use the chosen Draconic Origin. The type of damage associated with your Draconic Origin is your Draconic damage.
...
**Fallen Angelborn:** If you choose to play an Angelborn and go down a darker path, you can choose to be a Fallen Angelborn. You gain the following Ancestry Trait:
...
- **(2) Celestial Magic:** You learn 1 Spell of your choice from the Divine Spell List (Holy & Restoration during the Beta). Once per Long Rest, you can cast the chosen Spell spending 1 less MP than normal (minimum of 0 MP). The Spell's total MP cost (before all reductions) still can't exceed your Mana Spend Limit.
...
**Fiendborn Origin:** Choose a Fiendborn Origin from the following list: Cold, Corrosion, Fire, Poison, and Umbral. All future choices within this Ancestry must use the chosen Fiendborn Origin. The type of damage associated with your Fiendborn Origin is your Fiendish damage.

**Fiendborn Redemption:** If you choose to play a Fiendborn and go down a path of redemption, you can choose to be a Redeemed Fiendborn. You gain the following Ancestry Trait:
...
Beastborn is a unique Ancestry — it has no Default Traits. Instead, Beastborn get access to categories of Expanded Traits called **Beast Traits**. You can spend your Ancestry Points on any of the Beast Traits below.

**Beastborn Origin:** Choose a type of Beast you're modeled after, such as a frog, elephant, lion, spider, rabbit, dog, or something else. You're a Humanoid creature with an appearance based on the chosen Beast.
...
### Beast Traits
*(You can only choose a Beast Trait once unless it says otherwise.)*
...
- **(1) Thick-Skinned:** While you aren't wearing Armor, you gain +1 AD.
- **(2) Powerful Build:** You increase by 1 Size, but you occupy the Space of a creature 1 Size smaller.
- **(3) Long-Limbed:** When you make a Melee Martial Attack that hits, your reach is 1 Space greater than normal.
